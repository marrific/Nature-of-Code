  ...
  bg.loadPixels();
   ...
   for (int i = 0; i < width; i++) {
     for (int j = 0; j < height; j++) {
       ...
       if (pixelLoc < 12200 && pixelLoc > 12000) {
        println(bg.pixels[pixelLoc]); 
       }
       //if ((bg.pixels[pixelLoc] == color(-16777215) || bg.pixels[pixelLoc] == color(1073741824))) { //1342177280, 536870912, 805306368, 1073741824
       if (bg.pixels[pixelLoc] == color(1073741824) /*|| bg.pixels[pixelLoc] == color(536870912) */) {
